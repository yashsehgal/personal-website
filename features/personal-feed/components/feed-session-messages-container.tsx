...
import { FeedMessagesContentCollectionContainer } from "@/features/personal-feed/components/feed-messages-content-collection-container";
  ...
  return (
    <div className="flex min-h-0 min-w-0 flex-2 flex-col divide-y divide-border">
      ...
      <div className="min-h-0 min-w-0 flex-2 relative">
        <FeedMessagesContentCollectionContainer key={feedSession} />
        {showMessageBox ? (
