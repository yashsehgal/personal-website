        ...
        <section className="work-experience-container">
            <div className="work-experience-content-wrapper mt-20">
                ...
                <div className="work-experience-list-wrapper mt-6">
                    <ul className="work-experience-list grid grid-cols-2 items-start justify-start gap-3">
                                ...
                                >
                                    <div className="w-fit h-fit flex flex-col items-start justify-start gap-1">
                                        {workExperience?.coverImage
                                            ? <div className="work-experience-comapny-cover-image mb-1 bg-white rounded w-[420px] h-[200px] flex flex-row items-center justify-center border border-gray-200 overflow-hidden">
                                                <img src={workExperience?.coverImage}
                                                    className={workExperience?.company?.toLowerCase() === "clamp"
                                                        || "max-w-[200px] max-h-[100px]"
                                                    }
                                                    alt="company-cover"
                                                />
                                            </div>
