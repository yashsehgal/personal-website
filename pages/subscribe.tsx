...
const SubscribeToNewsletterView: React.FunctionComponent = () => {
  const imageWrapperClass: ClassValue
    = cn("w-56 h-56 overflow-hidden flex flex-row items-center justify-center shadow-2xl rounded-[52px] border-4 border-black transition-all hover:shadow hover:scale-90 max-xl:w-40 max-xl:h-40 max-lg:w-24 max-lg:h-24 max-xl:rounded-[42px] max-lg:rounded-2xl max-lg:border-2 max-md:hidden")
  return (
    <>
      <MetaHead
        title={"Subscribe to newsletter | Yash Sehgal"}
        description={"subscribe to my newsletter for frequest updates on my engineering journey. i share about my learnings, crafts and life."}
        embedSource={{
          twitter: "https://ik.imagekit.io/eawrckp8wfi/portfolio-image-source/seo/subscribe%20to%20newsletter%20cover_beAQwH1AT.png?updatedAt=1691257541383&tr=w-1200%2Ch-675%2Cfo-auto",
          linkedin: "https://ik.imagekit.io/eawrckp8wfi/portfolio-image-source/seo/subscribe%20to%20newsletter%20cover_beAQwH1AT.png?updatedAt=1691257541383&tr=w-1200%2Ch-628%2Cfo-auto",
      ...
      <div className="subscribe-to-newsletter-view-container font-sans">
        <ViewContainer className={'my-16 flex flex-row items-stretch justify-center'}>
          <div className="hero-section-wrapper max-xl:items-start max-xl:flex max-xl:flex-col">
            ...
            <Button
              ...
              onClick={() => window.open('https://yashsehgal.substack.com/embed')}>
              {"Subscribe to my newsletter"}
            </Button>
          </div>
          <div className="images-wrapper relative max-xl:hidden w-full">
            <div className={cn(imageWrapperClass, "absolute -rotate-6 left-48 top-56")}>
              <Image
                src={"/media/yash-lift.png"}
                alt="yash-elevator"
                width={"400"}
            ...
            <div className={cn(imageWrapperClass, "absolute rotate-6 top-40 left-12")}>
              <Image
                src={"/media/flight.png"}
                alt="god-in-flight"
                width={"400"}
