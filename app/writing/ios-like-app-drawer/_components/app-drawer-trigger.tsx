...
export function AppDrawerTrigger({ setIsOpen }: AppDrawerTriggerProps) {
  ...
  return (
    <motion.button
      ...
      <div className="w-6 h-6 rounded-md border-y border-l border-white/10 -z-20 bg-transparent" />
      <div className="w-8 h-8 rounded-lg border-y border-l border-white/20 -z-10 -ml-5 bg-transparent" />
