...
export function IntegrationManager() {
  ...
  return (
    <>
      {!showConnectionCard && (
        <motion.button
          className="p-2 rounded-full bg-bg-white text-gray-500 border absolute bottom-4 right-4 border-neutral-200"
      ...
      {showConnectionCard && (
        <div className="w-full h-full relative">
          <motion.button
            className="p-1 rounded-full bg-bg-white text-gray-500 border absolute bottom-64 right-4 border-neutral-200"
          ...
          <motion.div
            key="integrations"
            className="w-72 bg-white border rounded-br-2xl rounded-xl absolute bottom-4 right-4 overflow-hidden divide-y border-neutral-200 divide-neutral-200"
            ...
            <div className="p-4 flex items-center justify-between relative overflow-hidden">
              ...
              {!isSlackConnected && !showRipple && (
                <motion.button
                  className="border rounded-lg px-3 py-1 text-xs bg-white hover:bg-gray-50 border-neutral-200"
            ...
            <div className="p-4 flex items-center justify-between">
              ...
              <motion.button
                className="border rounded-lg px-3 py-1 text-xs bg-white hover:bg-gray-50 disabled:hover:bg-white disabled:opacity-50 border-neutral-200"
                disabled>
                Connect
              </motion.button>
            </div>
