'use client';
import { AutomationLog } from '@/app/posts/automation-flow-component/components/automation-log';
import { AutomationLogUserDetails } from '@/app/posts/automation-flow-component/components/automation-log-user-details';
import { GitHubAutomationCard } from '@/app/posts/automation-flow-component/components/github-integration-card';
import { SlackAutomationCard } from '@/app/posts/automation-flow-component/components/slack-integration-card';
import {
  AUTOMATION_LOG_INTERVAL_CHANGE_DELAY,
  AUTOMATION_LOGS,
} from '@/app/posts/constants/main';
...
export function AutomationFlow(): JSX.Element {
  ...
  return (
    <div className="AutomationFlow-container font-sans space-y-8">
      <div className="AutomationFlow-logs-container p-1 rounded-xl border border-neutral-200 w-[520px]">
        <div className="AutomationFlow-logsCard-container bg-white rounded-lg drop-shadow">
          <div className="AutomationFlow-logsCard-topSection-container p-2.5 border-b border-neutral-200">
